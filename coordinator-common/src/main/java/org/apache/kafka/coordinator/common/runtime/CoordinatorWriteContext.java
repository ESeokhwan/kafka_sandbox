...
/**
 * An immutable view captured under the active coordinator lock when a write executes.
 ...
 */
public record CoordinatorWriteContext(long highWatermark, int leaderEpoch) {
}
