...
/**
 * The physical record batch and transaction metadata returned by a data leader.
 */
public record GlobalSequencePhysicalFetchResult(
    MemoryRecords records,
    List<GlobalSequenceAbortedTransaction> abortedTransactions
) {
    public GlobalSequencePhysicalFetchResult {
