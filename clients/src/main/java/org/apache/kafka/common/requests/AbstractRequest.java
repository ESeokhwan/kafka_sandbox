    ...
    private static AbstractRequest doParseRequest(ApiKeys apiKey, short apiVersion, Readable readable) {
        switch (apiKey) {
            ...
            case FETCH_GLOBAL_SEQUENCE:
                return FetchGlobalSequenceRequest.parse(readable, apiVersion);
            case READ_GLOBAL_SEQUENCE_DATA:
                return ReadGlobalSequenceDataRequest.parse(readable, apiVersion);
            ...
            case BROKER_EXTENSION:
                return BrokerExtensionRequest.parse(readable, apiVersion);
            default:
