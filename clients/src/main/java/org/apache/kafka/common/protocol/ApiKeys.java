...
public enum ApiKeys {
    ...
    REGISTER_GLOBAL_SEQUENCE_INDEXER(ApiMessageType.REGISTER_GLOBAL_SEQUENCE_INDEXER, true),
    DESCRIBE_GLOBAL_SEQUENCE_PARTITION(ApiMessageType.DESCRIBE_GLOBAL_SEQUENCE_PARTITION, true),
    APPEND_GLOBAL_SEQUENCE_INDEX(ApiMessageType.APPEND_GLOBAL_SEQUENCE_INDEX, true),
